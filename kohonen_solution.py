...
class SOM:
    ...
    def learn(self,train_samples,epochs,lrate,width,verbose=False):
        ...
        for i in range(epochs):
            ...
            #Premier essai
#            lrate = lrate - 1/epochs
#            width = width - 1/epochs
            #Deuxième essai - Référence : "Réseaux de neuronnes" par Jean-Philippe Rennard
            lrate = lrateDebut*numpy.exp(-i/epochs) 
#            width = widthDebut*numpy.exp(-i/T)
            #Troisième essai
#            lrate = lrate - 1/epochs**2
#            width = width - 1/epochs**2
